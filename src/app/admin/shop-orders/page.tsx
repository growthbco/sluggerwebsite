...
export default async function AdminShopOrdersPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 py-14">
      ...
      <h1 className="display text-4xl text-foreground mt-3">🛒 Shop &amp; Store Orders</h1>
      <p className="mt-2 text-muted">
        Individual card purchases from the shop and team stores. Quote-first team orders live on the dashboard.
      </p>

      <div className="mt-8 border border-line divide-y divide-[color:var(--line)]">
        {active.length === 0 && <p className="px-3 py-4 text-sm text-muted">No shop or team-store purchases yet.</p>}
        {active.map((o) => (
