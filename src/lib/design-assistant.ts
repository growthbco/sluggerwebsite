...
function buildGrounding(design: DesignContext, order: OrderContext | null, messages: DesignMessage[], taughtFacts: string[] = []): string {
  ...
  return [
    ...
    "- Production: standard production is 3 weeks after final design approval, final roster submission, and deposit payment; shipping time is additional. Confirmed rush ($100 for 1–49 pieces; $150 for 50+ pieces) targets 2 weeks. Deadlines inside 2 weeks require a manual priority quote. Hats are embroidered in-house and small hat orders are often ready in days.",
    "- Rush orders: rush is $100 for 1–49 pieces or $150 for 50+ pieces (priority production, ships direct to the client). Staff must confirm the deadline - never guarantee a date yourself; say the team is reviewing the order and will follow up.",
