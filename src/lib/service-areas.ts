...
const metroProcess = (city: string) => [
  ...
  { t: "3. Payment and production", d: "Standard orders can start with a 50% deposit and target 3 weeks after the final proof, roster, and payment. Confirmed 2-week Rush is $100 for 1–49 pieces or $150 for 50+ pieces and requires full payment before production; direct shipping is included." },
...
const metroCommonFaqs = (city: string) => [
  ...
  { q: `How long does a ${city} uniform order take?`, a: "Standard production is 3 weeks after the final proof, final roster, and deposit are complete. Confirmed 2-week Rush is $100 for 1–49 pieces or $150 for 50+ pieces, requires full payment before production, and includes direct shipping." },
];
...
export const SERVICE_AREAS: ServiceArea[] = [
  {
    ...
    faqs: [
      ...
      { q: "How long does an Orlando uniform order take?", a: "Standard production is 3 weeks after the final proof, final roster, and deposit are complete. Confirmed 2-week Rush is $100 for 1–49 pieces or $150 for 50+ pieces, requires full payment before production, and includes direct shipping." },
