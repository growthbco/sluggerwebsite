...
export const FAQS: Faq[] = [
  { q: "How much does custom gear cost?", a: "Flat per-piece pricing with the custom design included: round-neck jerseys are $28 (any sport), two-button $32, full-button $35, quarter-zips $38, pants and hoodies $40, shorts $25, embroidered hats $25-30, socks $15. Custom orders start at 6 pieces per design; embroidered hats have no minimum. See the full list on our Pricing page. Prices are plus tax." },
