...
export const FAQS: Faq[] = [
  { q: "How much does custom gear cost?", a: "Flat per-piece pricing with the custom design included: round-neck jerseys are $28 (any sport), two-button $35, full-button $38, pants and hoodies $40, shorts $25, embroidered hats $25-30, socks $15. Custom orders start at 6 pieces per design; embroidered hats have no minimum. See the full list on our Pricing page. Prices are plus tax." },
  ...
  { q: "Is there a minimum order?", a: "Custom orders start at 6 pieces per design - every design takes real mockup and production setup, so 6 is the floor on custom gear. Need fewer? Custom embroidered hats have no minimum (embroidered in-house), and our shop and buy-in drops are single-piece friendly." },
  ...
  { q: "How much is a custom hype chain?", a: "The mockup is free - we design it to match your team's logo and colors so you can see it first. Producing the real 3D file is a one-time $50 charge per design, then each chain starts at $40 depending on how detailed the design and colors are. Order one for the dugout or a set for the whole roster.", link: { href: "/hype-chains", label: "See custom hype chains" } },
