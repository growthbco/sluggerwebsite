...
export const FAQS: Faq[] = [
  ...
  { q: "Is there a minimum order?", a: "No hard minimum - but full custom team designs are built for groups, not single pieces, since every design takes real mockup and setup work. Small squads are welcome; reach out and we'll work with you. Need just one custom item? Custom embroidered hats have truly no minimum, and our shop and buy-in drops are single-piece friendly." },
