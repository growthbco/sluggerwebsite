...
export const STANDARD_INVOICE_TERMS = [
  ...
  "Please double-check names, numbers, and sizes before paying - items are produced exactly as ordered. Custom and personalized items are non-refundable and non-returnable, except for covered manufacturing defects or production errors. Report any issue within 7 calendar days of carrier-recorded delivery, final-package delivery for a multi-package order, or the recorded local-pickup handoff, and we will review it under our Returns & Exchanges policy.",
