...
export const SPORT_PAGES: SportPage[] = [
  {
    ...
    priceNote: "Top and bottom sized separately · design included · same price youth to adult · 6-piece minimum per design",
    metaTitle: "Custom Cheer Uniforms & Rhinestone Sets - Free Design | Slugger Athletics",
    metaDescription:
      "Custom sublimated cheer uniforms and full sets - crop-top and skirt sets, briefs, pom-poms, bows, socks, and bags - with your colors, mascot graphics, and optional rhinestone detailing. Free design, from $120, made in Ocala FL.",
    intro:
      "Custom sublimated cheer uniforms and full sets, designed free in your colors with custom mascot graphics and optional applied rhinestones. Crop-top and skirt sets, briefs, pom-poms, bows, socks, and bags, made in Ocala FL and shipped nationwide.",
    mockup: "/styles/sport-cheer.jpg",
    offerings: [
      { t: "Cheer Uniforms", d: "Sublimated crop-top and skirt sets in your colors, simple or finished with applied rhinestones. Tops and bottoms are sized separately." },
    ...
    deepDive: [
      "Cheer uniforms take a beating - tumbling, stunting, and a full season of competitions - so we dye your colors, patterns, and mascot graphics directly into the fabric. The sublimated artwork will not crack or peel. For extra competition sparkle, genuine applied rhinestones are available as a separate finish.",
    ...
    faqs: [
      ...
      { q: "How long does a cheer order take?", a: "Standard production is three weeks after final design approval, final roster submission, and deposit payment. A confirmed rush ($100 for 1–49 pieces; $150 for 50+ pieces) targets two weeks; shipping time is additional." }, { q: "Do you make youth cheer uniforms, and what is the minimum order?", a: "Yes - youth cheer uniforms come in every size from Youth Small up at the same flat price as adult. The minimum is 6 pieces per design, and the design mockup is free. Standard production is three weeks after final approval, roster, and deposit." },
    ],
    pricing: [
      { label: "Top + Skirt Set", cents: 12000 },
      { label: "Rhinestone Top + Skirt", cents: 17500 },
  ...
  },
  {
    ...
    faqs: [{"q": "How much do custom baseball uniforms cost?", "a": "Jerseys run $28 (crew), $30 (V-neck), $32 (two-button), $35 (full-button), and $40 (quarter-zip) with the design included. Pants are $40 and hats are $30. Tax and shipping are separate."}, {"q": "How long does a baseball uniform order take?", "a": "Standard production is 3 weeks after the final proof, final roster, and deposit are complete. Confirmed 2-week Rush production is $100 for 1–49 pieces or $150 for 50+ pieces. Shipping time is additional."}, {"q": "Do you do travel ball home and away sets?", "a": "All the time - our Home & Away bundle (2 jerseys + pants) starts at $90 per player, and each family can buy their own set through your free team store."}, {"q": "Do you make youth baseball uniforms, and what is the minimum order?", "a": "Yes - youth baseball uniforms and jerseys come in every size from Youth Small up at the same flat price as adult, with names and numbers included. The minimum is 6 pieces per design, and the design mockup is free. Standard production is 3 weeks after the final proof, roster, and deposit; shipping time is additional."}],
  ...
  },
  {
    ...
    offerings: [
      ...
      { t: "Clear Production Timing", d: "Standard production is 3 weeks after the final proof, final roster, and deposit. Confirmed 2-week Rush is $100 for 1–49 pieces or $150 for 50+ pieces; shipping time is additional." },
    ],
    localBody:
  ...
  },
  {
    ...
    offerings: [
      ...
      { t: "Clear Production Timing", d: "Standard production is 3 weeks after the final proof, final roster, and deposit. Confirmed 2-week Rush is $100; shipping time is additional." },
    ],
    localBody:
    ...
    pricing: [{ label: "Jerseys from", cents: 2800 }, { label: "Custom shorts", cents: 2500 }, { label: "Practice jerseys", cents: 2000 }, { label: "Quarter-zips", cents: 4000 }],
  },
  {
