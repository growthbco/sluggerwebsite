...
export const SPORT_PAGES: SportPage[] = [
  ...
  },
  {
    ...
    faqs: [{"q": "How much are custom pickleball shirts?", "a": "Quality dry-fit club shirts are $20 each with your design included. Premium jersey builds start at $28, and matching embroidered visors and hats have no minimum."}, {"q": "Can members buy their own shirts?", "a": "Yes - we set up a free online club store where every member orders and pays for their own shirt and size. The club never collects money."}, {"q": "Do you serve The Villages?", "a": "We are about 40 minutes north in Ocala - delivery to The Villages or pickup at the shop, whichever your club prefers."}],
  },
  {
